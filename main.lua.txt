...
if env.__HYDRAHubLoading then
    warn("[HYDRAHub] Loader is already running.")
    return
end

env.__HYDRAHubLoading = true

local BASE_URL =
    "https://raw.githubusercontent.com/matheusandradesilba194-hash/HYDRA-Hub/main/"
...
local ROUTES = {
    ...
    ["107778070777162"] = { name = "Steal An Egg",   file = "HYDRAHub(StealAnEgg).lua" },
}
...
env.__HYDRAHubLoading = nil

if not success then
    warn("[HYDRAHub] " .. tostring(loaderError))
end
